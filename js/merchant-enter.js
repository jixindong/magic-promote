                ...
                imgs.forEach((e, i) => {
                    if (i === 0) {
                        ...
                        $('#banner-carousel .carousel-inner').append(
                            `<div class="carousel-item active"><img src="${e}" class="d-block w-100"><button type="button" class="btn btn-primary" data-toggle="modal" data-target="#starApply">立即开通</button></div>`
                        );
                    } else if (i === 1) {
                        $('#banner-carousel .carousel-indicators').append(
